...
(() => {
    ...
    const blurredContent = document.querySelector('.blurred-content-hidden'); // Elemento para aplicar o desfoque
    ...
    const closeMenu = () => {
        ...
        blurredContent.classList.remove(blurredContentClass); // Remova a classe de desfoque ao fechar o menu
    };

    const showMenu = () => {
        buttonShowMenu.classList.remove(buttonShowMenuVisibleClass);
        menuContainer.classList.remove(menuHiddenClass);
        blurredContent.classList.add(blurredContentClass); // Adicione a classe de desfoque ao abrir o menu
    };
